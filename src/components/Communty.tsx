  ...
  return (
    <article className="px-[5%] pb-28 lg:py-20 lg:h-[100vh] flex flex-col lg:flex-row items-start justify-between">
      <section className="w-full lg:w-[60%]">
        <h4 className="text-5xl lg:leading-[5rem] lg:text-7xl font-extrabold lg:font-bold mb-4 md:mb-0  text-black">
          This is
        </h4>
        <h4 className="text-5xl lg:leading-[5rem] lg:text-7xl font-extrabold lg:font-bold mb-4 md:mb-0  text-black  lg:block">
      ...
      <section className="w-full lg:w-[36%] relative flex justify-center py-6 mt-28 lg:mt-0">
        <img
          src={communityImg}
          alt=""
