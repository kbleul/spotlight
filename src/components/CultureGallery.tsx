...
const CultureGallery = () => {
  ...
  return (
    <article className="h-[100vh] bg-black flex items-start justify-evenly">
      <section className="w-[22%] feeds_scroll flex flex-col h-[100vh] gap-4 overflow-y-hidden hover:overflow-y-scroll">
