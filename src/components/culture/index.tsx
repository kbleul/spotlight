      ...
      >
        <section className="px-2 md:px-0 w-full lg:w-1/2 flex flex-col items-start lg:items-center gap-y-[6vh] lg:gap-y-[18vh] h-full relative order-2 lg:order-1  mt-10 lg:mt-0">
          <img
            src={cultureImg2}
            alt=""
            className="w-1/2 max-w-[380px] z-10"
          ...
          <img
            src={cultureImg3}
            alt=""
            className="w-1/2 max-w-[380px] z-10 absolute bottom-0"
            onMouseEnter={(event: React.MouseEvent<HTMLImageElement>) =>
        ...
        <section className="w-full lg:w-1/2 lg:px-[8%] order-1 lg:order-2">
          {/* <img
            src={cultureTrace}
            alt=""
            className="w-full max-w-[0px] lg:max-w-[500px]"
          /> */}
          <h2 className="stroke-black text-[#4F4F4F] text-[70px] md:text-6xl pt-6 pl-2 lg:pt-16 text-left  font-extrabold">
            Culture
          </h2>
          ...
          <div className="pl-3 w-full">
            ...
            <p className=" mt-4 lg:text-2xl text-[#4f4f4f] text-lg md:text-2xl">
