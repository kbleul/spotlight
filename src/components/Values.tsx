...
const Values = () => {
  return (
    <article className="px-[5%] py-20 lg:h-[93vh] bg-black flex flex-col lg:flex-row items-start justify-between overflow-hidden">
      <section className="w-full ml-[9%] min-h-[60vh] lg:min-h-0 lg:w-[48%] mt-[16vh] lg:mt-0 relative order-2 lg:order-1">
        <img
          src={communityImg}
          alt=""
          className="absolute w-[351px] lg:w-[500px]"
          style={{
            left: -50,
            top: -50,
        ...
        <img
          src={communityImg2}
          alt=""
          className="absolute w-[400px] customImg3"
          style={{
      ...
      <section className="w-full lg:w-[48%] lg:pt-[20vh] order-1 lg:order-2">
        <h4 className="text-5xl lg:text-6xl font-bold  text-white">
          We Don’t Stop
        </h4>

        <p className="max-w-[600px] text-white lg:text-[#777777] font-medium mt-10 lg:text-2xl">
