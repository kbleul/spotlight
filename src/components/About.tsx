...
const About = () => {
  ...
  return (
    <article className="px-[2%] md:px-[7%]">
      <h2 className="stroke-black text-[#4F4F4F] text-[123px] pt-16 text-center lg:text-left md:text-[115px] font-extrabold">
        About
      </h2>
      <article className="  pt-2  overflow-hidden text-black bg-white flex items-start justify-between ">
        <section
          ref={ref}
          className="pt-8 pb-28 flex flex-col md:flex-row items-start justify-between"
        >
          <motion.div
            className="w-full lg:w-[65%] lg:px-0 "
            initial={inView ? { x: -600 } : { x: 0 }}
            animate={inView ? { x: 0 } : { x: -600 }}
            transition={{ duration: 1 }}
          >
            <h5 className="font-extrabold md:text-4xl mt-8 mb-3 md:mb-0">
              We Take The Stage
            </h5>
          ...
          <motion.div
            className="w-full lg:w-[30%] hidden lg:flex justify-center items-start  pt-4 "
